% GID_mesh: genera el archivo de salida de la "Geometria" para GiD 
%           (Desplazamientos,deformaciones y tensiones)
% function GID_mesh(prob_name,e_Matrix,e_Var)
function GID_mesh(prob_name,coord,conec,e_VG)
...
% conec1 = zeros(size(conec));
% conec1(:,1:4) = conec(:,1:2:end);
% conec1(:,5:8) = conec(:,2:2:end);
